...
import { handleMcpMessage, MCP_SERVER_INFO } from './news-mcp-core.mjs'

const host = process.env.NEWS_MCP_HOST || '127.0.0.1'
const port = Number(process.env.NEWS_MCP_PORT || 8789)
const mcpPath = process.env.NEWS_MCP_PATH || '/mcp'
const maxBodyBytes = Number(process.env.NEWS_MCP_MAX_BODY_BYTES || 1024 * 1024)
