...
import { handleMcpMessage, MCP_SERVER_INFO } from './weather-mcp-core.mjs'

const host = process.env.WEATHER_MCP_HOST || '127.0.0.1'
const port = Number(process.env.WEATHER_MCP_PORT || 8787)
const mcpPath = process.env.WEATHER_MCP_PATH || '/mcp'
const maxBodyBytes = Number(process.env.WEATHER_MCP_MAX_BODY_BYTES || 1024 * 1024)
